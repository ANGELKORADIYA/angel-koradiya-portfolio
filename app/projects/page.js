...
const projects = [
  ...
  },
  {
    ...
    link: 'https://quiz-3hxz.onrender.com/', 
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-20 p-6 flex flex-col items-center">
      <div className="max-w-6xl w-full p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 mt-8 justify-items-center"> 
          {projects.map((project, index) => (
            <div key={index} className="bg-white max-w-xs h-64 p-4 rounded-lg shadow-lg transition transform hover:scale-105 flex flex-col mx-auto">
